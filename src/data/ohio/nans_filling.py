...
def fill_nans(data, day_len, n_days_test):
    ...
    - Carbs values are filled with 0
    - Missing meals replaced with NoMeal category
    ...
    for col in data.columns:
        if "insulin" in col or "CHO" in col or 'carbs' in col:
            data[col] = data[col].fillna(0)
        elif "meal" in col:
            data[col] = data[col].fillna("NoMeal")
